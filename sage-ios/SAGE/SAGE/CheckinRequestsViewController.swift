...
class CheckinRequestsViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let checkin = Checkin(user: User(firstName: "Alison", lastName: "Reichl", imgURL: "http://i1.wp.com/pmcdeadline2.files.wordpress.com/2014/09/matt_bomer_white_collar_wallpaper-t2.jpg?crop=0px%2C10px%2C400px%2C268px&resize=446%2C299"), startTime: NSDate(timeIntervalSinceNow: 0), endTime: NSDate(timeIntervalSinceNow: 1000),comment: "some sort of excuse blah blah blah as;ldkfjals;kjf blah balh")
